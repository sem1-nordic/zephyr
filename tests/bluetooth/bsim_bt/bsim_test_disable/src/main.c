...
extern struct bst_test_list *test_scanner_install(struct bst_test_list *tests);
extern struct bst_test_list *test_advertiser_install(struct bst_test_list *tests);
